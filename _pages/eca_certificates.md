...
<div class="main-content">
  <div id="eca-certifications">
    ...
    <ul style="font-size: 15px; text-align: justify; padding-left: 20px;">
      <li><strong>LinkedIn Learning:</strong> Advanced Graph Neural Networks | Nov 2025</li>

      <li><strong>LinkedIn Learning:</strong> Quantum Computing Fundamentals | Nov 2025</li>

      <li><strong>Udemy:</strong> QC101 Quantum Computing & Intro to Quantum Machine Learning | Oct 2025</li>

      <li><strong>LinkedIn Learning:</strong> Computer Vision for Data Scientists | Aug 2024</li>

      <li><strong>Udemy:</strong> Data Science and Supply Chain Analytics: A to Z with Python | Sep 2023</li>

      <li><strong>Coursera:</strong> Bayesian Methods for Machine Learning | May 2023</li>

      <li><strong>DataCamp:</strong> Python Fundamentals | Aug 2022</li>

      <li><strong>edX:</strong> Industry 4.0: How to Revolutionize your Business | Sep 2020</li>
    </ul>
  </div>
</div>
<hr>
